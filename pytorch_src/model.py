...
class HMRNetBase(nn.Module):
    ...
    def _create_sub_modules(self):
        '''
            add smpl model, SMPL can create a mesh from beta & theta
        '''
        ...
        if self.encoder_name == 'resnet50':
            ...
            assert 0
        '''
            regressor can predict betas(include beta and theta which needed by SMPL) 
            from coder extracted from encoder in a iteratirve way
        '''
