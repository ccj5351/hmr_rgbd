...
def main(img_path, json_path=None):
    ...
    dict_to_save = {}
    dict_to_save['joints2d_pd'] = joints[0] # [0] is along batch_size dimension, here we just set batch_size = 1;
    dict_to_save['joints3d_pd'] = joints3d[0] # [0] is along batch_size dimension, here we just set batch_size = 1;
