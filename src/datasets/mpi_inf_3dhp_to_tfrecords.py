...
def get_all_data(base_dir, sub_id, seq_id, cam_ids, all_cam_info):
    ...
    print ('img_dir = %s, anno_path = %s' %(img_dir, anno_path))
    #sys.exit()
    ...
    for cam_id in cam_ids:
        ...
        flength = 0.5 * (K[0, 0] + K[1, 1]) # focal lengths expressed in pixel units;
        ppt = K[:2, 2] # principal point that is usually at image center;
